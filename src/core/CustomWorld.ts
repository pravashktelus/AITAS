...
import { MobileEngine } from '../core/MobileEngine';
...
export class CustomWorld extends World {
  ...
  public mobileEngine!: MobileEngine;
  public accessibilityEngine!: AccessibilityEngine;
  public apiEngine: ApiEngine;
  public testUserManager: TestUserManager;
  public nativeAppEngine: NativeAppEngine | null = null;
  ...
  public initActionEngine(): void {
    ...
    this.mobileEngine = new MobileEngine(page, context);
    this.accessibilityEngine = new AccessibilityEngine(page);
    ...
    Logger.info('MobileEngine: READY');
    Logger.info('AccessibilityEngine: READY');
  }
